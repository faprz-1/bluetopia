    ...
    path: '', component: LayoutComponent, children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'grado/:grade/grupo/:group/plantillas/:templateId/nuevo-proyecto', loadChildren: () => import('../pages/teacher-template-form/teacher-template-form.module').then(m => m.TeacherTemplateFormModule) },
        ]
      },
    ]
  }
