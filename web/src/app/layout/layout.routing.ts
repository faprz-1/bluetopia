...
export const ADMIN_MENU_PAGES: any = {
  ...
  'Teacher': [
    ...
    { name: 'Home', action: '/inicio/teacher/mis-estudiantes', icon: 'zmdi zmdi-accounts', iconImg: 'home.svg' },
    ...
    { name: 'Gráficas de resuktados', action: '/inicio/teacher/mis-estudiantes', icon: 'zmdi zmdi-accounts', iconImg: 'bar_chart.svg' },
