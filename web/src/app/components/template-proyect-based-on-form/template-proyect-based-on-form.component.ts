...
@Component({
  selector: 'app-template-proyect-based-on-form',
  templateUrl: './template-proyect-based-on-form.component.html',
  styleUrls: ['./template-proyect-based-on-form.component.scss']
})
export class TemplateProyectBasedOnFormComponent implements OnInit {
